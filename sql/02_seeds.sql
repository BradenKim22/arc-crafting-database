...
(1,'Advanced ARC Powercell','valuable resource that drops from certain ARC ewnemies','Rare','Arc (high level enemies)'),
...
(27,'Bombardier Cell','Can be recycled into crafting materials.','Epic','Arc (Bombadier)'),
...
(72,'Durable Cloth','Used to craft medical supplies.','Uncommon','Medical of Commercial'),
...
(76,'Expired Pasta','Way pasta its prime.','Common','Commercial or Residential'),
